...
if __name__ == '__main__':
    def generate_plots():
        ...
        con = MySQLdb.connect(host='devsdb',
                              port=3306,
                              user=os.environ['SDBUSER'],
                              passwd=os.environ['SDBPASS'],
                              db='sdb_v6')
        show(time_breakdown_plot(db_connection=con,
                                 plot_date=plotdate,
                                 interval=my_interval,
                                 title='Weekly Time Breakdown - {first_night} - {last_night}',
                                 plot_width=600,
                                 plot_height=600))
        priority_breakdown(db_connection=con,
                           plot_date=plotdate,
                           interval=my_interval,
        ...
        total_time_breakdown(db_connection=con,
                             plot_date=plotdate,
                             interval=my_interval,
